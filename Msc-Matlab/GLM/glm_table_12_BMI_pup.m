% table 10- GLM analysis of spring pup BMI 2022-2023 + herz 22
    ...
    for r = 2:length(var_list)
        ...
        for i = 1:num_combinations
            ...
            try
                ...
                numeric_predictor_variables = {'density_5km','density_15km','date','parasites','temprature_IMS','pup_gender'};
