% figure 11b, pup FA by density spring 2023 (15km radius)
...
mean_Jaffa_spring = [mean(spring_jaffa.FA_pup,"omitnan")];
mean_Shontsino_spring = [mean(spring_shontsino.FA_pup,"omitnan")];
mean_Bridge_spring = [mean(spring_bridge.FA_pup,"omitnan")];
mean_Center_spring = [mean(spring_center.FA_pup,"omitnan")];
mean_Aseret_spring = [mean(spring_aseret.FA_pup,"omitnan")];
mean_Bneibrit_spring = [mean(spring_Bnei_Brit.FA_pup,"omitnan")];
mean_BeitGovrin_spring = [mean(spring_Beit_Govrin.FA_pup,"omitnan")];
mean_Segafim_spring = [mean(spring_Segafim.FA_pup,"omitnan")];
mean_Tinshemet_spring = [mean(spring_Tinshemet23.FA_pup,"omitnan")];
...
ylabel('Pup forearm length [mm]',FontWeight='bold');
