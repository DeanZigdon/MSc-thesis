%%  figure 10a 2023 pup weight between colony types, boxplot 
...
weight_pup_rural = rural_data.pup_weight;
weight_pup_city = city_data.pup_weight;
...
ylabel('Pup weight [gr]', 'FontSize', 12, 'FontWeight', 'bold');
...
for i = 1:numel(unique_colonies_rural)
    ...
    colony_fa_pup = colony_data.pup_weight;
