%% figure 9b 2023 spring pup presence by colony type
data = readtable("springcityandcountrynojuv.csv");

pregnant_data = data(data.pup == 1, :);
...
ylabel('Pup Proportion', 'FontSize', 12, 'FontWeight', 'bold');
hold on;
